    ...
    >
      ...
      >
        ...
        <p
          style={{
            color: "#a0adb8",
            fontSize: "clamp(0.6rem, 0.62vw, 0.66rem)",
            lineHeight: 1.65,
            textAlign: "center",
            margin: 0,
          }}
        >
          Confidential. No attorney-client relationship is created by submitting this form. By providing
          your phone number you consent to receive SMS updates from our office.
        </p>
      </form>
    </div>
  );
