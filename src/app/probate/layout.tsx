...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Probate Attorney Houston, TX | Law Office of Troy M. Moore, PLLC",
    description: "Houston probate attorney Troy M. Moore guides families through the Texas probate process — from simple estates to complex will contests and fiduciary litigation.",
    url: "https://troymoorelaw.com/probate",
  },
};
