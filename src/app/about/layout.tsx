...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "About the Firm | Law Office of Troy M. Moore, PLLC",
    description: "For 25+ years, the Law Office of Troy M. Moore, PLLC has guided Houston families through probate, estate planning, and will disputes with experience and compassion.",
    url: "https://troymoorelaw.com/about",
  },
};
